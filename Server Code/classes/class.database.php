...
/***
	...
	Latest Revision: December 15th, 2010
...
class CF_Database extends MySQLi {
	...
	public function __construct() {
		...
		parent::__construct( CF_DB_CONNECT_HOST, CF_DB_CONNECT_USER, CF_DB_CONNECT_PASS, CF_DB_CONNECT_DBNAME );
		if ( $this->connect_error ) {
			throw new Exception( 'An error occurred while connecting to the database!' );
		}
		if ( !$this->set_charset( 'utf8' ) ) {
			throw new Exception( 'Error loading character set.' );
		}
	}
	...
	public function submitErrorLog( $SQLKey = null, $description = '' ) {
		...
		$query	=	'
			INSERT INTO		' . CF_ERROR_LOG_TABLE . '
